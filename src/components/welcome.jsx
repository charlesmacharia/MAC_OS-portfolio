...
const setupTextHover = (container, type) => {
    ...
    const handleMouseMove = (e) => {
        ...
        letters.forEach((letter) => {
            // this(below) gets  the start position of the character by seeing where the  utmost left part is and the width of the character
            const { left: l, width: w } = letter.getBoundingClientRect();

            // this (below) gets the  absolute distance of the mouse from the character.
